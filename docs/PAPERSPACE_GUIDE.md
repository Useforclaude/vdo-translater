...
6. [การตรวจสอบความคืบหน้า](#6-การตรวจสอบความคืบหน้า)
7. [การถอดเสียงแบบแบ่งช่วง](#7-การถอดเสียงแบบแบ่งช่วง)
8. [การดาวน์โหลดผลลัพธ์](#8-การดาวน์โหลดผลลัพธ์)
9. [แก้ปัญหาที่พบบ่อย](#9-แก้ปัญหาที่พบบ่อย)
10. [คำสั่งที่ใช้บ่อย (Quick Reference)](#10-คำสั่งที่ใช้บ่อย-quick-reference)
...
## 6. การตรวจสอบความคืบหน้า

### 6.1 เช็คสถานะแบบรวดเร็ว (ไม่ต้องเข้า tmux)
...
### 6.2 Watch mode (auto-refresh ทุก 5 วินาที)
...
## 7. การถอดเสียงแบบแบ่งช่วง

### 7.1 ทำไมต้องแบ่งช่วง?
...
### 7.2 ตัวอย่าง: วิดีโอ 2 ชั่วโมง แบ่งเป็น 4 ช่วง
...
### 7.3 รวม transcripts ทั้ง 4 ช่วง
...
## 8. การดาวน์โหลดผลลัพธ์

### 8.1 ตรวจสอบว่าเสร็จแล้ว
...
### 8.3 คัดลอกไปยัง /notebooks/ (เพื่อดาวน์โหลด)
...
### 9.2 Error: Checkpoint file corrupt
...
## 10. คำสั่งที่ใช้บ่อย (Quick Reference)
